  ...
  return (
    <section
      className={cn(
        ...
        open ? 'relative z-[999]' : 'relative z-10',
      )}
    >
      {/* Header */}
      ...
      {showInput && (
        <div className="relative mt-4">
          ...
          {open && suggestions.length > 0 && (
            <div className="absolute left-0 right-[-48px] top-full z-[9999] mt-2 max-h-52 overflow-y-auto rounded-2xl border border-white/80 bg-white/95 p-1.5 shadow-xl backdrop-blur no-scrollbar animate-pop-in">
              {suggestions.map((s) => (
                <button
                  key={s}
                  type="button"
